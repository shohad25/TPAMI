...
\markboth{IEEE TRANSACTIONS ON PATTERN ANALYSIS AND MACHINE INTELLIGENCE, ~VOL.~XX, NO.~XX, March~2018}%
{Shell \MakeLowercase{\textit{et al.}}: Accelerated Magnetic Resonance Imaging by Generative Adversarial Neural Networks}
...
%\end{frontmatter}
\begin{IEEEkeywords}
	Accelerated MRI, Adversarial Loss, Deep Neural Networks, K-space.
\end{IEEEkeywords}}
...
\begin{figure}[H]
	...
	} & \subfloat[\textcolor{black}{\scriptsize{}}]{\centering{}\includegraphics[width=1.8cm,height=1.8cm]{include/grp2/example_samplingMask4.png}\label{fig:pair_of_k_space_mri_mask}
	
} & \subfloat[\textcolor{black}{\scriptsize{}}]{\centering{}\includegraphics[width=1.8cm,height=1.8cm]{include/grp2/example_zeroPadding.png}\label{fig:pair_of_k_space_mri_example}
}\tabularnewline
