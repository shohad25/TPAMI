...
%	pdfpagemode={UseOutlines},plainpages=false,pdfpagelabels=true,
%	colorlinks=true,linkcolor={black},citecolor={black},urlcolor={black},
%	pdftitle={Accelerated Magnetic Resonance Imaging by Adversarial Neural Network},
%	pdfsubject={Typesetting},%<!CHANGE!
%	pdfauthor={Ohad Shitrit, Tammy Riklin Raviv},%<!CHANGE!
%	pdfkeywords={Accelerated MRI, Adversarial Loss, Deep Neural Network, K-space}}
...
\author{Ohad~Shitrit, Tammy Riklin Raviv~\IEEEmembership{}% <-this % stops a space
	\IEEEcompsocitemizethanks{
		\IEEEcompsocthanksitem O. Shitrit T. Riklin Raviv are with The Department of Electrical Engineering, and the Zlotowski Center for Neuroscience, Ben-Gurion University of the Negev, Israel.
		\protect\\
		E-mail: rrtammy@ee.bgu.ac.il; shohad25@gmail.com}% <-this % stops a space
	\thanks{Manuscript received XX, 2018; revised XX, 2018.}}
%		\fontfamily{qtm}\selectfont
%\begin{frontmatter}

\markboth{Journal of \LaTeX\ Class Files,~Vol.~XX, No.~XX, Feb~2018}%
{Shell \MakeLowercase{\textit{et al.}}: Accelerated Magnetic Resonance Imaging by Adversarial Neural Network}
...
%\end{frontmatter}
\begin{IEEEkeywords}
	Accelerated MRI, Adversarial Loss, Deep Neural Network, K-space.
\end{IEEEkeywords}}
...
\IEEEPARstart{M}{Magnetic} Resonance Imaging (MRI) is a non-ionizing imaging modality, and is therefore widely used in diagnostic medicine and biomedical research. The physical principles of MRI are based on a strong magnetic field and pulses of radio frequency (RF) electromagnetic radiation. 
...
\begin{figure}[H]
	...
	\begin{tabular}{cccc}
		\subfloat[\textcolor{black}{\scriptsize{}}]{\centering{}\includegraphics[width=1.8cm,height=1.8cm]{include/grp1/example_mask_kspace_with_arrows}
			
		} & \subfloat[\textcolor{black}{\scriptsize{} }]{\centering{}\includegraphics[width=1.8cm,height=1.8cm]{include/grp2/example_original.png}
		
	} & \subfloat[\textcolor{black}{\scriptsize{}}]{\centering{}\includegraphics[width=1.8cm,height=1.8cm]{include/grp2/example_samplingMask4.png}
	
} & \subfloat[\textcolor{black}{\scriptsize{}}]{\centering{}\includegraphics[width=1.8cm,height=1.8cm]{include/grp2/example_zeroPadding.png}
}\tabularnewline
...
\begin{figure}[H]
	\centering{}\includegraphics[width=8.0cm,height=4.5cm]{include/grp2/system_chart}\caption{\label{fig:system} \textcolor{black}{\footnotesize{}{}Framework
...
\begin{figure*}[ht]
	...
	\begin{tabular}{|c|}
		\hline 
		\subfloat[\textcolor{black}{\footnotesize{}Generator}]{\centering{}\includegraphics[width=10cm,height=2cm]{include/grp2/generator_arch} 
			
		}\tabularnewline
		\hline 
		\hline 

		\subfloat[\textcolor{black}{\footnotesize{}Discriminator}]{\centering{}\includegraphics[width=10cm,height=2cm]{include/grp2/discrimonator_arch} 
...
We perform k-space sampling using a 2D random Gaussian mask. Thus, we exploit the sparsity in both phase and frequency dimensions and are therefore able to accommodate higher sampling factors (Figure~\ref{fig:sampling_masks}). MRI reconstruction is performed using 40\%, 25\%, and 16.6\% of the original k-space data.
...
\begin{figure}[H]
	...
	\setlength\tabcolsep{1.5pt}
	\begin{tabular}{ccc}
		\subfloat[{\scriptsize 40\%}]{\includegraphics[width=2.0cm, height=2.0cm]{include/grp2/mask2}}
		& 
		\subfloat[{\scriptsize 25\%}]{\includegraphics[width=2.0cm, height=2.0cm]{include/grp2/mask4}}
		&
		\subfloat[{\scriptsize 16.66\%}]{\includegraphics[width=2.0cm, height=2.0cm]{include/grp2/mask6}}
		\tabularnewline
...
%	&
%	\subfloat[\footnotesize Hausdorff distance]{\includegraphics[width=2cm, height=2.2cm]{include/grp2/hausdorff}}
%	\tabularnewline
%
...
%Additional examples of different cases, using sampling factors of 4~(25\%), and 2.5~(40\%) are shown in Figures~\ref{fig:example_factor_4},~\ref{fig:example_factor_2.5}, respectively.
